...
class TP_ForgotPassword extends StatefulWidget {
  @override
  _TP_ForgotPasswordState createState() => _TP_ForgotPasswordState();
}

class _TP_ForgotPasswordState extends State<TP_ForgotPassword> {
